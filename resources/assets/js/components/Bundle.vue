                                ...
                                <div class="modal-body">
                                    ...
                                    <ul>
                                        <li v-for="product in products" :key="product.id">
                                            {{ product.name }}
                                            <button class="btn btn-sm btn-danger" @click="removeProductFromBundle(result.id, product.id)">Delete</button>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li v-for="avproduct in avproducts" :key="avproduct.id">
                                            {{ avproduct.name }}
                                            <button class="btn btn-sm btn-success" @click="addProductToBundle(result.id, avproduct.id)">Add</button>
                                        </li>
                                    </ul>
                                </div>
